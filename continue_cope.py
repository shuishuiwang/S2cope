...
CMD = r"K:\工作\蓝丰\LF_code\Maincode\cal_water_quality.py"                 #需要执行程序的绝对路径，支持jar 如：D:\\calc.exe 或者D:\\test.jar
# CMD = r"H:\paper_important\code\py6s\AtmosphericCorrection-master\AtmosphericCorrection-master\test.py"                 #需要执行程序的绝对路径，支持jar 如：D:\\calc.exe 或者D:\\test.jar
